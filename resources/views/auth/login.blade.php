                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="/" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bold">SIP</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Selamat datang di SIP! 👋</h4>
                        <p class="mb-4">Mohon masuk ke akun anda untuk memulai</p>
                        ...
                        <form id="formAuthentication" method="POST" class="mb-3" action="{{ route('login') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('email') is-invalid @enderror"
                                    id="email" name="email" placeholder="" autofocus />
                                @error('email')
